...
const createNewTask = async function createNewTask(name, description, estimatedTime, status, ownerId, assignedUserId, followerIds) {
...
const updateTaskDetails = async (id, name, description, estimatedTime, status) => {
